            ...
            <div class="header-area">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <h3 class="mt-1">Hasil GAP - <?= $_SESSION['level']; ?></h3>
                    </div>
                ...
                <div class="sales-report-area mt-2 mb-5">
                    ...
                    <div class="card shadow mt-3 mb-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Hasil Nilai GAP</h6>
                        </div>
                        <div class="card-body">
                            <a href="laporan_gap.php" target="_blank" class="btn btn-danger"><i class="fa fa-print"></i> Cetak</a>
